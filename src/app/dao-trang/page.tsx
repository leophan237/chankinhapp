...
export default function DaoTrangPage() {
  ...
  return (
    <div className="min-h-screen bg-[#191919] text-gray-100">
      ...
      {/* Notification Ticker */}
      <div className="bg-gradient-to-r from-amber-500/10 via-amber-400/5 to-amber-500/10 border-b border-amber-500/20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4">
          <div className="py-3 flex items-center gap-4 animate-[scroll_20s_linear_infinite]">
            <span className="text-sm whitespace-nowrap text-amber-200/90">
              🔔 <span className="font-semibold">Masan CEO</span> đã thích bài viết của bạn
            </span>
            <span className="text-gray-600">•</span>
            <span className="text-sm whitespace-nowrap text-amber-200/90">
              📋 <span className="font-semibold">Tập đoàn Vingroup</span> vừa gửi lời mời đấu thầu dự án của bạn
            </span>
            <span className="text-gray-600">•</span>
            <span className="text-sm whitespace-nowrap text-amber-200/90">
              🔔 <span className="font-semibold">Masan CEO</span> đã thích bài viết của bạn
                ...
                <div className="flex-1 space-y-3">
                  ...
                  <div className={`relative transition-all duration-300 ${
                    isInputFocused || attachments.length > 0 
                      ? 'ring-1 ring-gray-700 rounded-xl bg-[#2a2a2a]' 
                      : ''
                  }`}>
                    <textarea
                      value={newPost}
                  ...
                  <div className="flex justify-end gap-2">
                    ...
                    <Button
                      ...
                      className={`bg-amber-500 hover:bg-amber-600 text-white transition-colors ${
                        !newPost.trim() && attachments.length === 0
                  ...
                  >
                    <Card className="bg-[#202020] border-gray-800/50 overflow-hidden">
                      ...
                      {post.attachments && post.attachments.length > 0 && (
                        <div className={`grid gap-0.5 bg-[#2a2a2a] ${
                      ...
                      <div className="px-2 py-1 border-b border-gray-800/50 flex items-center justify-around">
                        <Button
                          ...
                          className={`flex-1 rounded-lg h-10 text-gray-400 hover:text-white hover:bg-white/5 transition-colors ${
                            likedPosts.has(post.id) ? 'text-blue-400 hover:text-blue-400 hover:bg-blue-400/10' : ''
                          }`}
                        >
                                ...
                                <div className="flex items-center gap-2 pl-2">
                                  <Button
                                    ...
                                    className={`text-gray-500 hover:text-white hover:bg-white/5 h-8 px-2 ${
                                      likedComments.has(comment.id) ? 'text-blue-400 hover:text-blue-400 hover:bg-blue-400/10' : ''
                                    }`}
                                  >
          ...
          <aside className="hidden lg:block lg:col-span-3">
            <div className="sticky top-24 space-y-4">
              ...
              <div className="text-xs text-gray-600 px-2 space-y-1">
                ...
                <p>© 2025 Đạo Tràng. Tất cả quyền được bảo lưu.</p>
              </div>
            </div>
          </aside>
        </div>
