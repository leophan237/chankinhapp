...
export const metadata: Metadata = {
  title: 'All-in F&B — Khóa Huấn Luyện Toàn Diện Cho Founder Ngành F&B | XCAP × Chân Kinh',
  ...
  keywords: ['khóa học F&B', 'kinh doanh F&B', 'startup F&B', 'XCAP', 'Chân Kinh', 'All-in F&B', 'founder F&B', 'khởi nghiệp ẩm thực'],
  openGraph: {
