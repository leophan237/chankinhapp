...
async function generateMetadata({ params }) {
    ...
    const mockPost = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_POSTS"].find((p)=>p.slug.current === slug);
    if (mockPost) {
        return {
...
async function PostPage({ params }) {
  ...
  `;
    let sanityPosts = [];
    try {
        sanityPosts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sanity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["client"].fetch(query);
    } catch (error) {
    ...
    const currentPost = allPosts.find((p)=>p.slug.current === slug);
    if (!currentPost) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a73f803e._.js.map