module.exports = [
"[project]/node_modules/sanity/lib/_chunks-es/QRCodeSVG.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useQRCode(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$compiler$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(24), { value, level, minVersion, includeMargin, marginSize, logoSize, size } = t0;
    let t1;
    ...
    const { cells: cells_0, margin: margin_0, numCells: numCells_0, calculatedImageSettings: calculatedImageSettings_0 } = t3;
    let t4;
...
function QRCodeSVGComponent(props) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$compiler$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"])(26), { value, size: t0, level: t1, color: t2, minVersion: t3, title, logoSize } = props, size = t0 === void 0 ? DEFAULT_SIZE : t0, level = t1 === void 0 ? DEFAULT_LEVEL : t1, color = t2 === void 0 ? DEFAULT_FGCOLOR : t2, minVersion = t3 === void 0 ? DEFAULT_MINVERSION : t3;
    let t4;
    ...
    const { margin, cells, numCells, calculatedImageSettings } = useQRCode(t4);
    let t5;
    ...
    let t8;
    $[13] !== title ? (t8 = !!title && /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsx"])("title", {
        children: title
    }), $[13] = title, $[14] = t8) : t8 = $[14];
    let t10, t11, t9;
    ...
    let t13;
    return $[21] !== size || $[22] !== t12 || $[23] !== t7 || $[24] !== t8 ? (t13 = /* @__PURE__ */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxs"])("svg", {
        height: size,
        width: size,
        viewBox: t7,
        role: "img",
...
//# sourceMappingURL=node_modules_sanity_lib__chunks-es_QRCodeSVG_1a99235e.js.map