...
function compileSchemaDefinitionToPortableTextMemberSchemaTypes(definition) {
    const blockObjects = definition?.blockObjects?.map((blockObject)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineType"])({
            type: "object",
        ...
        })) ?? [], inlineObjects = definition?.inlineObjects?.map((inlineObject)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["defineType"])({
            type: "object",
            // Very naive way to work around `SanitySchema.compile` adding default
            // fields to objects with certain names.
    ...
    return {
        ...
        portableText: {
            ...
            of: pteSchema.portableText.of.map((schemaType)=>{
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isObjectSchemaType"])(schemaType)) return schemaType;
                const nameMapping = blockObjectNames[schemaType.name];
                schemaType.name = nameMapping ?? schemaType.name;
                for (const field of schemaType.fields)if (!(field.name !== "children" || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$sanity$2f$types$2f$lib$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isArraySchemaType"])(field.type))) for (const ofSchemaType of field.type.of){
...
const inputRuleListenerCallback = ({ input, sendBack })=>{
    ...
    guards: {
        "block offset changed": ({ context, event })=>{
            ...
            if (!event.blockOffsets || !context.endOffsets) return !0;
...
//# sourceMappingURL=node_modules_%40portabletext_b3d26af7._.js.map