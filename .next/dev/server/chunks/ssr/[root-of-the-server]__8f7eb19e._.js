...
async function getPosts() {
    ...
    try {
        const sanityData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$sanity$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["client"].fetch(query, {}, {
            next: {
                revalidate: 60
            }
        });
        // Merge sanity data with mock data, preferring sanity data if IDs clash
        const mergedPosts = [
            ...sanityData || []
        ];
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_POSTS"].forEach((mock)=>{
            if (!mergedPosts.some((p)=>p._id === mock._id)) {
                mergedPosts.push(mock);
            }
        });
        return mergedPosts;
    } catch (error) {
        console.error("Failed to fetch posts:", error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mockData$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["MOCK_POSTS"];
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8f7eb19e._.js.map